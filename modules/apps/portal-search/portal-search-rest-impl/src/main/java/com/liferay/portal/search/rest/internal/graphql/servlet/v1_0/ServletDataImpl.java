...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		...
		Query.setInferenceEndpointResourceComponentServiceObjects(
			_inferenceEndpointResourceComponentServiceObjects);
			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						"mutation#createEmbeddingInferenceEndpoint",
						new ObjectValuePair<>(
							InferenceEndpointResourceImpl.class,
							"postEmbeddingInferenceEndpoint"));
					put(
					...
					put(
						"query#embeddingInferenceServices",
						new ObjectValuePair<>(
							InferenceEndpointResourceImpl.class,
							"getEmbeddingInferenceServicesPage"));
					put(
						"query#search",
						new ObjectValuePair<>(
...
// LIFERAY-REST-BUILDER-HASH:1730658032