...
public abstract class BaseInferenceEndpointValidationResourceImpl
	implements InferenceEndpointValidationResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search/v1.0/inference-endpoint/validate' -d $'{"errorMessage": ___, "inferenceId": ___, "service": ___, "serviceSettings": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "InferenceEndpointValidation"
			)
		}
	)
	@jakarta.ws.rs.Consumes({"application/json", "application/xml"})
	@jakarta.ws.rs.Path("/inference-endpoint/validate")
	@jakarta.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseInferenceEndpointValidationResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:-265560886