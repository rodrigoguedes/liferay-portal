...
public class InferenceEndpoint implements Serializable {
	...
	public String getTaskType() {
		if (_taskTypeSupplier != null) {
			taskType = _taskTypeSupplier.get();

			_taskTypeSupplier = null;
		}
	...
	public void setTaskType(
		UnsafeSupplier<String, Exception> taskTypeUnsafeSupplier) {

		_taskTypeSupplier = () -> {
			try {
				return taskTypeUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _taskTypeSupplier;
...
// LIFERAY-REST-BUILDER-HASH:-1239382394