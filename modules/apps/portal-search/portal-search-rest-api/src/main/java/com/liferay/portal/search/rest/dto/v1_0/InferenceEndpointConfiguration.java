...
@XmlRootElement(name = "InferenceEndpointConfiguration")
public class InferenceEndpointConfiguration implements Serializable {

	public static InferenceEndpointConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(
			InferenceEndpointConfiguration.class, json);
	}

	public static InferenceEndpointConfiguration unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.search.rest.dto.v1_0.InferenceEndpointConfiguration",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:276254379