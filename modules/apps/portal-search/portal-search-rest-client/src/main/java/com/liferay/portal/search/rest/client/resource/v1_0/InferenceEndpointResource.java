...
public interface InferenceEndpointResource {
	...
	public HttpInvoker.HttpResponse
			getEmbeddingInferenceServicesPageHttpResponse()
		throws Exception;
	...
	public HttpInvoker.HttpResponse postEmbeddingInferenceEndpointHttpResponse(
			InferenceEndpointConfiguration inferenceEndpointConfiguration)
		throws Exception;
	...
	public static class InferenceEndpointResourceImpl
		...
		public Page<InferenceService> getEmbeddingInferenceServicesPage()
			...
			try {
				return Page.of(content, InferenceServiceSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search/v1.0/embeddings/inference-services");
		...
		public InferenceEndpoint postEmbeddingInferenceEndpoint(
			...
			HttpInvoker.HttpResponse httpResponse =
				postEmbeddingInferenceEndpointHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				inferenceEndpointConfiguration.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search/v1.0/embeddings/inference-endpoints");
...
// LIFERAY-REST-BUILDER-HASH:-803289846